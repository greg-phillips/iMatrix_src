...
# ///
"""
OpenAI LLM Script for iMatrix_Client

Uses OpenAI's GPT models for generating completion messages and agent names.

Usage:
    uv run oai.py "your prompt here"   # General prompting
    uv run oai.py --completion         # Generate completion message
    uv run oai.py --agent-name         # Generate agent name
"""
...
def main():
    ...
    if len(sys.argv) > 1:
        ...
        print("Usage: ./oai.py 'prompt' | --completion | --agent-name")
