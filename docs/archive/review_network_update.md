...
=== Processing Interface 0: eth0 ===
  Enabled:          Yes
  Mode:             server
[00:00:10.864] Applying eth0 configuration: mode=server, IP=192.168.7.1
...
--- DHCP Server Settings ---
  Interface:        eth0
  IP Range Start:   192.168.8.100
  IP Range End:     192.168.8.200
...
=== Processing Interface 1: wlan0 ===
  Enabled:          Yes
  Mode:             client
[00:00:10.972] Applying wlan0 configuration: mode=client
[HOSTAPD] Removing hostapd config for client mode
[HOSTAPD] Backed up /etc/network/hostapd.conf to /etc/network/hostapd.conf.orig
...
[BLACKLIST-DIAG] Dumping all 2 interfaces:
...
[00:00:11.155] Applied 1 network configuration changes
[00:00:11.162] ======================================
[00:00:11.162] NETWORK CONFIGURATION CHANGED
[00:00:11.162] System will reboot in 5 seconds
[00:00:11.162] ======================================
[00:00:11.174] Network configuration will be applied after reboot

## Contents of Key files after program running.

root@QConnect:/home# ls -alt /etc/network/
total 122
drwxr-xr-x    1 root     root          4080 Nov  2 18:03 .
-rw-------    1 root     root           411 Nov  2 18:03 interfaces
-rw-------    1 root     root           400 Nov  2 18:03 udhcpd.eth0.conf
...
root@QConnect:/home# cat /etc/network/wpa_supplicant.conf
