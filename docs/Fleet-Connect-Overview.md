...
- Format: `.cfg.bin` (generated by CAN_DM tool)
- Contains: Product definition, CAN nodes, signals, network config
- Versioned structure for backward compatibility
- Checksum validation

**Configuration Loading:**
```c
bool read_config(const char *filename, config_t *config);
```

**Configuration Sections:**
1. Product information
2. Control/Sensor definitions
3. CAN bus 0 nodes and signals
4. CAN bus 1 nodes and signals
5. CAN bus 2 (Ethernet) nodes and signals
6. Network interface configuration
7. Internal sensors configuration
8. DBC signal settings
9. DBC files metadata
10. CAN bus hardware configuration
