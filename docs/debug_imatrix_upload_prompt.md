...
Valid acknowledgements do not see to be clearing pending data
...
read all source files in iMatrix/imatrix_upload special focus on upload and response processing
...
2. Detailed plan document, *** docs/debug_imatrix_upload_plan.md ***, of all aspectsa and detailed todo list for me to review before commencing the implementation.
